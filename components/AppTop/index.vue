      ...
      <div class="branding docs-branding">
        <div class="container-fluid position-relative py-2">
            <div class="docs-logo-wrapper">
              <button id="docs-sidebar-toggler" v-on:click="sidebarTogglerfun()" class="docs-sidebar-toggler docs-sidebar-visible me-2 d-xl-none" type="button">
                <span></span>
                <span></span>
                <span></span>
	            </button>
            ...
            <div class="top-search-box d-none d-lg-flex">
              ...
              <b-form-group  label-for="tags-with-dropdown" class="">
                ...
                >
                  ...
                  <b-list-group-item v-on:click='Hiden = false'>{{ option }}</b-list-group-item>
                  </NuxtLink>
                </b-list-group>
