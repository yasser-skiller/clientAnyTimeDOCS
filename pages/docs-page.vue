					...
					<section class="docs-section" id="item-1-2">
						...
						<div class="simplelightbox-gallery row mb-3">
							<div class="col-12 col-md-4 mb-3">
						        <a href="assets/images/coderpro-home.png"><img class="figure-img img-fluid shadow rounded" :src="require(`~/assets/images/q.png`)" alt="" title="CoderPro Home Page"/></a>
							</div>
							<div class="col-12 col-md-4 mb-3">
						        <a href="assets/images/coderpro-features.png"><img class="figure-img img-fluid shadow rounded" :src="require(`~/assets/images/coderpro-features-thumb.png`)" alt="" title="CoderPro Features Page"/></a>
							</div><!--//col-->
							<div class="col-12 col-md-4 mb-3">
						        <a href="assets/images/coderpro-pricing.png"><img class="figure-img img-fluid shadow rounded" :src="require(`~/assets/images/coderpro-pricing-thumb.png`)" alt="" title="CoderPro Pricing Page"/></a>
							</div><!--//col-->
